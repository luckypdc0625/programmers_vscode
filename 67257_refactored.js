...
function solution(expression) {
    ...
    for (let i=0; i<6; i++) {
        ...
        var opers = opers_s[i];
        opers.forEach((val, idx) => {
            oper_what(temp_exp_arr, val);
        });
        var temp_answer = Math.abs(temp_exp_arr[0]);
